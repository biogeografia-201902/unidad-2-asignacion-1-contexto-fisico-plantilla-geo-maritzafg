...
* Genera un gráfico de precipitación anual de RD en un gradiente Norte-Sur, a lo largo de un transecto elegido para ti y utilizando la serie de datos [WorldClim, versión 2]((http://worldclim.org/version2)) [@fick2017worldclim].
